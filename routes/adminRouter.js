...
for (const n of notes) {
  ...
  // // ==========================
  // // Ops: Process anomaly detected (NO link)
  // // Admin: Suspicious Activity Detected (WITH link)
  // for (const it of filteredIncidents.slice(0, 20)) {
  //   if ((it.severity || 1) < 3) continue; // only notify meaningful severity
